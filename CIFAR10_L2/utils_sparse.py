...
def search_fine(model, x, y, vec_threshold, batch_size, complete_address, attacks, attack_norm):
    model.eval()
    ...
    adversary = AutoAttack(model, norm=attack_norm, eps=0.5, version='custom', attacks_to_run=attacks)
